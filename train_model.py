...
def parse_arguments(argv):
    ...
    parser.add_argument('--logs_base_dir', type=str, help='Directory where to write event logs.', default='~/models/voice/VoxCeleb/')
    parser.add_argument('--models_base_dir', type=str, help='Directory where to write trained models and checkpoints.', default='~/data/ChuyuanXiong/up/wav')
    ...
    parser.add_argument('--data_set', type=str, help="data set position.", default='/data/ChuyuanXiong/up/wav')
